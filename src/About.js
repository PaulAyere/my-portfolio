...
import profilePicture from './assets/Image/hero42.png';
      ...
      <div className="flex flex-col sm:flex-row justify-between">
        ...
        <div className="flex items-center justify-center w-full sm:w-1/3 mx-2">
          <img
            src={profilePicture}
            alt="Profile"
            className="rounded-full w-64 h-64 bg-gradient-to-r from-fuchsia-900 to-pink-400 sm:w-80 sm:h-80 mx-auto mb-4 sm:mb-0"
          />
        </div>

        {/* Personal Information */}
        <div className="w-full sm:w-1/3 mx-2 mt-4 sm:mt-10">
